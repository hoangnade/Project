 ...
 * @author manch
 */
@WebServlet(name = "LoadDetailServlet", urlPatterns = {"/load-detail"})
public class LoadDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            AccountDetailId accDetail = dao.getOneAccountDetail(pid);
