 ...
 * @author manch
 */
@WebServlet(name = "changeInfor", urlPatterns = {"/change-infor"})
public class changeInfor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean accDetail = new AccountDetailDao().updateInfor(account.getAccontdetailID(), AccountDetailId.builder()
                    .id(account.getAccontdetailID())
                    .name(name)
